  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        >
          {/* Section Title */}
          <h2 className="text-4xl md:text-5xl font-judul font-bold text-gradient mb-8 text-center">
            About Me
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
            ...
            <div className="bg-transparent border-2 border-latar-tersier rounded-xl p-6 hover:border-aksen-primer transition-all duration-300 group">
